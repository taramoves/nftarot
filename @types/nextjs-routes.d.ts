...
declare module "nextjs-routes" {
  ...
  export type Route =
    | StaticRoute<"/">
    | StaticRoute<"/about">
    | StaticRoute<"/card-reveal">
    | StaticRoute<"/card-select">
    | StaticRoute<"/components/Arch">
    | StaticRoute<"/components/BeginModal">
    | StaticRoute<"/components/Card/MintedCard">
    | StaticRoute<"/components/Card/SingleCard">
    | StaticRoute<"/components/NavBar">
    | StaticRoute<"/components/Page">
    | StaticRoute<"/components/TextContainer">
    | StaticRoute<"/lib/fonts">
    | StaticRoute<"/profile">
    | StaticRoute<"/theme">
    | StaticRoute<"/theme/components/arch">
    | StaticRoute<"/theme/components/button">
    | StaticRoute<"/theme/components/fullPage">
    | StaticRoute<"/theme/components/modal">
    | StaticRoute<"/theme/components/navbar">
    | StaticRoute<"/theme/components/textContainer">
    | StaticRoute<"/theme/foundations/colors">
    | StaticRoute<"/theme/styles">;
